...
public class ImageUtils80px {

    public static final int AVATAR_WIDTH = 80;
    public static final int AVATAR_HEIGHT = 80;
    ...
    public int getDominationColor(Bitmap bitmap){
        if (bitmap==null)
        ...
        bitmap2.getPixels(pixels, 0, width, 0, 0, width, heigth);
