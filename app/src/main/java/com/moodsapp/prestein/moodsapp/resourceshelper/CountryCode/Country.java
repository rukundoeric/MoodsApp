...
public class Country {
    ...
    public Country(String countryNameCode,String countryCode,String countryName) {
    ...
    public int getFlagResID(String country) {
    ...
    public void AddCountryInList(ArrayList<Country> countries) {
    ...
    public String divideString(Context context,String cName)
    {
        String fCountryName=null;
        char space=' ',coma=',';
        for (int i=0;i<cName.length();i++)
        {
            if(cName.charAt(i)==space||cName.charAt(i)==coma)
            {
                fCountryName=cName.substring(0,i);

                // Toast.makeText(context, "In if: "+fCountryName, Toast.LENGTH_LONG).show();
            }
            else
            {

                fCountryName=cName;
                //  Toast.makeText(context, "in else: "+fCountryName, Toast.LENGTH_LONG).show();
