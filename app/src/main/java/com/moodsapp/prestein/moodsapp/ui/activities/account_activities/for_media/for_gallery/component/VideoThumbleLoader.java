...
public class VideoThumbleLoader {
    ...
    private Bitmap getBitmap(String url) 
    {
		...
		Bitmap curThumb = MediaStore.Video.Thumbnails.getThumbnail(MoodsApp.applicationContext.getContentResolver(),
                ...
                while(true)
                {
                    ...
                    if(photosQueue.photosToLoad.size()!=0)
                    {
                        ...
                        if(tag!=null && tag.equals(photoToLoad.url)){
                            ...
                            Activity activity=getActivity(photoToLoad.imageView);
