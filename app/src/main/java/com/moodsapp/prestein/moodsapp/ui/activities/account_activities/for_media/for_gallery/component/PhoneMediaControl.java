package com.moodsapp.prestein.moodsapp.ui.activities.account_activities.for_media.for_gallery.component;
...
public class PhoneMediaControl {
	...
	public static void loadGalleryPhotosAlbums(Context mContext , final int guid) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                Cursor cursor = null;
                try {
                    cursor = MediaStore.Images.Media.query(MoodsApp.applicationContext.getContentResolver(), MediaStore.Images.Media.EXTERNAL_CONTENT_URI, projectionPhotos, "", null, MediaStore.Images.Media.DATE_TAKEN + " DESC");
                    if (cursor != null) {
	...
	public static void runOnUIThread(Runnable runnable, long delay) {
		if (delay == 0) {
			MoodsApp.applicationHandler.post(runnable);
		} else {
			MoodsApp.applicationHandler.postDelayed(runnable,delay);
		}
	}
